...
// Type: ProjectSubmissionsSvcLib.NetBuildOrderService.getNetworkOrderItems
...
namespace ProjectSubmissionsSvcLib.NetBuildOrderService
{
  ...
  [Serializable]
  public class getNetworkOrderItems : baseRequest
  {
    private OrderIdentifier[] networkOrderItemIdentifierField;

    [XmlElement("networkOrderItemIdentifier", Order = 0)]
