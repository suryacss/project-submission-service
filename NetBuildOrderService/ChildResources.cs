...
// Type: ProjectSubmissionsSvcLib.NetBuildOrderService.ChildResources
...
namespace ProjectSubmissionsSvcLib.NetBuildOrderService
{
  ...
  [Serializable]
  public class ChildResources : INotifyPropertyChanged
  {
    ...
    [XmlElement("TNOCCriteria", Order = 9)]
    ...
    [XmlElement("thirdPartyResource", Order = 10)]
    ...
    [XmlElement("systemPlan", Order = 11)]
    ...
    [XmlElement("siteSurvey", Order = 12)]
