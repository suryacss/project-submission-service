...
// Type: ProjectSubmissionsSvcLib.NetBuildOrderService.NetworkOrderItemComponent
...
namespace ProjectSubmissionsSvcLib.NetBuildOrderService
{
  ...
  [Serializable]
  public class NetworkOrderItemComponent : INotifyPropertyChanged
  {
    private string networkOrderItemComponentNameField;
    ...
    private string networkOrderItemComponentDescriptionField;
    private string networkOrderItemComponentProjectTypeField;
    private ActionableResource networkOrderItemComponentResourceField;

    [XmlElement(Order = 0)]
    public string networkOrderItemComponentName
    {
      get => this.networkOrderItemComponentNameField;
      set
      {
        this.networkOrderItemComponentNameField = value;
        this.RaisePropertyChanged(nameof (networkOrderItemComponentName));
      }
    }
    ...
    [XmlElement(Order = 6)]
    public string networkOrderItemComponentDescription
    {
      get => this.networkOrderItemComponentDescriptionField;
      set
      {
        this.networkOrderItemComponentDescriptionField = value;
        this.RaisePropertyChanged(nameof (networkOrderItemComponentDescription));
      }
    }

    [XmlElement(Order = 7)]
    public string networkOrderItemComponentProjectType
    {
      get => this.networkOrderItemComponentProjectTypeField;
      set
      {
        this.networkOrderItemComponentProjectTypeField = value;
        this.RaisePropertyChanged(nameof (networkOrderItemComponentProjectType));
      }
    }

    [XmlElement(Order = 8)]
    public ActionableResource networkOrderItemComponentResource
    {
