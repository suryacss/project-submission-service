...
// Type: ProjectSubmissionsSvcLib.NetBuildOrderService.ActionableResource
...
namespace ProjectSubmissionsSvcLib.NetBuildOrderService
{
  ...
  [Serializable]
  public class ActionableResource : INotifyPropertyChanged
  {
    ...
    private ChildResources childResourcesField;
    ...
    {
      get => this.childResourcesField;
      set
      {
        this.childResourcesField = value;
        this.RaisePropertyChanged(nameof (childResources));
      }
    }
