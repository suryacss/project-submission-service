...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ECCKT_SUPPLEMENTAL__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class ECCKT_SUPPLEMENTAL__History : sObject
  {
    ...
    private ECCKT_SUPPLEMENTAL__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public ECCKT_SUPPLEMENTAL__c Parent
    {
