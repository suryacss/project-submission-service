...
// Type: ProjectSubmissionsSvcLib.SalesforceService.RequestType_Options__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class RequestType_Options__c : sObject
  {
    ...
    private string requestType__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string RequestType__c
    {
      get => this.requestType__cField;
      set => this.requestType__cField = value;
    }
