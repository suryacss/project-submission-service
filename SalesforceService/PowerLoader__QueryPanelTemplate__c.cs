...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__QueryPanelTemplate__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class PowerLoader__QueryPanelTemplate__c : sObject
  {
    ...
    private QueryResult powerLoader__QueryPanelTemplateFields__rField;
    private string powerLoader__Query_Panel_Name__cField;
    ...
    [XmlElement(IsNullable = true)]
    public QueryResult PowerLoader__QueryPanelTemplateFields__r
    {
      get => this.powerLoader__QueryPanelTemplateFields__rField;
      set => this.powerLoader__QueryPanelTemplateFields__rField = value;
    }

    [XmlElement(IsNullable = true)]
    public string PowerLoader__Query_Panel_Name__c
    {
      get => this.powerLoader__Query_Panel_Name__cField;
      set => this.powerLoader__Query_Panel_Name__cField = value;
    }
