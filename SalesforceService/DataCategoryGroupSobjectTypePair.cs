...
// Type: ProjectSubmissionsSvcLib.SalesforceService.DataCategoryGroupSobjectTypePair
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class DataCategoryGroupSobjectTypePair
  {
    ...
    {
      get => this.dataCategoryGroupNameField;
      set => this.dataCategoryGroupNameField = value;
    }
