...
// Type: ProjectSubmissionsSvcLib.SalesforceService.DisableFeedTrackingHeader
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class DisableFeedTrackingHeader : SoapHeader
  {
    private bool disableFeedTrackingField;

    public bool disableFeedTracking
    {
      get => this.disableFeedTrackingField;
      set => this.disableFeedTrackingField = value;
    }
  }
}
