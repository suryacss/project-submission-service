...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PROJECT_HEADER__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PROJECT_HEADER__History : sObject
  {
    ...
    private PROJECT_HEADER__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public PROJECT_HEADER__c Parent
    {
