...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__Page_Layout_Cache__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PowerLoader__Page_Layout_Cache__c : sObject
  {
    ...
    private string powerLoader__Record_Type_ID__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string PowerLoader__Record_Type_ID__c
    {
      get => this.powerLoader__Record_Type_ID__cField;
      set => this.powerLoader__Record_Type_ID__cField = value;
    }
