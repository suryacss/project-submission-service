...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__PowerLoaderMapping__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PowerLoader__PowerLoaderMapping__c : sObject
  {
    ...
    private string powerLoader__Description__cField;
    private string powerLoader__ObjAPIName__cField;
    private QueryResult powerLoader__PowerLoaderFields__rField;
    ...
    [XmlElement(IsNullable = true)]
    public string PowerLoader__Description__c
    {
      get => this.powerLoader__Description__cField;
      set => this.powerLoader__Description__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string PowerLoader__ObjAPIName__c
    {
      get => this.powerLoader__ObjAPIName__cField;
      set => this.powerLoader__ObjAPIName__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public QueryResult PowerLoader__PowerLoaderFields__r
    {
      get => this.powerLoader__PowerLoaderFields__rField;
      set => this.powerLoader__PowerLoaderFields__rField = value;
    }
