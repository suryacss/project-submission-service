...
// Type: ProjectSubmissionsSvcLib.SalesforceService.REQUEST_FOR_PROPOSAL__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class REQUEST_FOR_PROPOSAL__History : sObject
  {
    ...
    private REQUEST_FOR_PROPOSAL__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public REQUEST_FOR_PROPOSAL__c Parent
    {
