...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Ecckt_Trigger_Control__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class Ecckt_Trigger_Control__c : sObject
  {
    ...
    private bool? upsert_ECCKT_Sup_Control__cField;
    private bool upsert_ECCKT_Sup_Control__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? Upsert_ECCKT_Sup_Control__c
    {
      get => this.upsert_ECCKT_Sup_Control__cField;
      set => this.upsert_ECCKT_Sup_Control__cField = value;
    }

    [XmlIgnore]
    public bool Upsert_ECCKT_Sup_Control__cSpecified
    {
      get => this.upsert_ECCKT_Sup_Control__cFieldSpecified;
      set => this.upsert_ECCKT_Sup_Control__cFieldSpecified = value;
    }
