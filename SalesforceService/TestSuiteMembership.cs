...
// Type: ProjectSubmissionsSvcLib.SalesforceService.TestSuiteMembership
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class TestSuiteMembership : sObject
  {
    ...
    private ApexTestSuite apexTestSuiteField;
    private string apexTestSuiteIdField;
    ...
    {
      get => this.apexTestSuiteField;
      set => this.apexTestSuiteField = value;
    }

    [XmlElement(IsNullable = true)]
    public string ApexTestSuiteId
    {
      get => this.apexTestSuiteIdField;
      set => this.apexTestSuiteIdField = value;
    }
