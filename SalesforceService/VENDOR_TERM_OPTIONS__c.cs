...
// Type: ProjectSubmissionsSvcLib.SalesforceService.VENDOR_TERM_OPTIONS__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class VENDOR_TERM_OPTIONS__c : sObject
  {
    ...
    private string vENDOR_TERM__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string VENDOR_TERM__c
    {
      get => this.vENDOR_TERM__cField;
      set => this.vENDOR_TERM__cField = value;
    }
  }
}
