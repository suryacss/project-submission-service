...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__Query_Panel__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PowerLoader__Query_Panel__c : sObject
  {
    ...
    private string powerLoader__Custom_Layout__cField;
    private QueryResult powerLoader__Query_Parameters__rField;
    ...
    [XmlElement(IsNullable = true)]
    public string PowerLoader__Custom_Layout__c
    {
      get => this.powerLoader__Custom_Layout__cField;
      set => this.powerLoader__Custom_Layout__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public QueryResult PowerLoader__Query_Parameters__r
    {
      get => this.powerLoader__Query_Parameters__rField;
      set => this.powerLoader__Query_Parameters__rField = value;
    }
