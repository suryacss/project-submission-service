...
// Type: ProjectSubmissionsSvcLib.SalesforceService.NoteAndAttachment
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class NoteAndAttachment : sObject
  {
    ...
    public bool? IsNote
    {
      get => this.isNoteField;
      set => this.isNoteField = value;
    }

    [XmlIgnore]
    public bool IsNoteSpecified
    {
      get => this.isNoteFieldSpecified;
      set => this.isNoteFieldSpecified = value;
    }
