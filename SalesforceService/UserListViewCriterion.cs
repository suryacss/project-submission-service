...
// Type: ProjectSubmissionsSvcLib.SalesforceService.UserListViewCriterion
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class UserListViewCriterion : sObject
  {
    ...
    private UserListView userListViewField;
    private string userListViewIdField;
    ...
    {
      get => this.userListViewField;
      set => this.userListViewField = value;
    }

    [XmlElement(IsNullable = true)]
    public string UserListViewId
    {
      get => this.userListViewIdField;
      set => this.userListViewIdField = value;
    }
