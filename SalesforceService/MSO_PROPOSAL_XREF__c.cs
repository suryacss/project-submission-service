...
// Type: ProjectSubmissionsSvcLib.SalesforceService.MSO_PROPOSAL_XREF__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class MSO_PROPOSAL_XREF__c : sObject
  {
    ...
    private string iFO_Win_Rate_Record__cField;
    private IFO_Win_Rate__c iFO_Win_Rate_Record__rField;
    ...
    private string mSO_City__cField;
    private string mSO_State__cField;
    private string mSO_Vendor_Type__cField;
    private string mSO_Vendor__cField;
    private string mSO_ZIP_CODE_Record__cField;
    private MSO_ZIP_CODE__c mSO_ZIP_CODE_Record__rField;
    private string mSO_ZIP__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string IFO_Win_Rate_Record__c
    {
      get => this.iFO_Win_Rate_Record__cField;
      set => this.iFO_Win_Rate_Record__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public IFO_Win_Rate__c IFO_Win_Rate_Record__r
    {
      get => this.iFO_Win_Rate_Record__rField;
      set => this.iFO_Win_Rate_Record__rField = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public string MSO_City__c
    {
      get => this.mSO_City__cField;
      set => this.mSO_City__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string MSO_State__c
    {
      get => this.mSO_State__cField;
      set => this.mSO_State__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string MSO_Vendor_Type__c
    {
      get => this.mSO_Vendor_Type__cField;
      set => this.mSO_Vendor_Type__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string MSO_Vendor__c
    {
      get => this.mSO_Vendor__cField;
      set => this.mSO_Vendor__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string MSO_ZIP_CODE_Record__c
    {
      get => this.mSO_ZIP_CODE_Record__cField;
      set => this.mSO_ZIP_CODE_Record__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public MSO_ZIP_CODE__c MSO_ZIP_CODE_Record__r
    {
      get => this.mSO_ZIP_CODE_Record__rField;
      set => this.mSO_ZIP_CODE_Record__rField = value;
    }

    [XmlElement(IsNullable = true)]
    public string MSO_ZIP__c
    {
      get => this.mSO_ZIP__cField;
      set => this.mSO_ZIP__cField = value;
    }
