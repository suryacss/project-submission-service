...
// Type: ProjectSubmissionsSvcLib.SalesforceService.L3_Note_Control__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class L3_Note_Control__c : sObject
  {
    ...
    private bool? l3_Note_Trigger__cField;
    private bool l3_Note_Trigger__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? L3_Note_Trigger__c
    {
      get => this.l3_Note_Trigger__cField;
      set => this.l3_Note_Trigger__cField = value;
    }

    [XmlIgnore]
    public bool L3_Note_Trigger__cSpecified
    {
      get => this.l3_Note_Trigger__cFieldSpecified;
      set => this.l3_Note_Trigger__cFieldSpecified = value;
    }
