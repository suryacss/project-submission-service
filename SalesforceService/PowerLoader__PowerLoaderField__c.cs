...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__PowerLoaderField__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PowerLoader__PowerLoaderField__c : sObject
  {
    ...
    private string powerLoader__CSVField__cField;
    private string powerLoader__ObjField__cField;
    private string powerLoader__PowerLoaderMapping__cField;
    private ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__PowerLoaderMapping__c powerLoader__PowerLoaderMapping__rField;
    private string powerLoader__RelField__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string PowerLoader__CSVField__c
    {
      get => this.powerLoader__CSVField__cField;
      set => this.powerLoader__CSVField__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string PowerLoader__ObjField__c
    {
      get => this.powerLoader__ObjField__cField;
      set => this.powerLoader__ObjField__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string PowerLoader__PowerLoaderMapping__c
    {
      get => this.powerLoader__PowerLoaderMapping__cField;
      set => this.powerLoader__PowerLoaderMapping__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__PowerLoaderMapping__c PowerLoader__PowerLoaderMapping__r
    {
      get => this.powerLoader__PowerLoaderMapping__rField;
      set => this.powerLoader__PowerLoaderMapping__rField = value;
    }

    [XmlElement(IsNullable = true)]
    public string PowerLoader__RelField__c
    {
      get => this.powerLoader__RelField__cField;
      set => this.powerLoader__RelField__cField = value;
    }
