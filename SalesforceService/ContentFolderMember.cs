...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ContentFolderMember
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  {
    private ContentDocument childRecordField;
    private string childRecordIdField;
    ...
    {
      get => this.childRecordField;
      set => this.childRecordField = value;
    }

    [XmlElement(IsNullable = true)]
    public string ChildRecordId
    {
      get => this.childRecordIdField;
      set => this.childRecordIdField = value;
    }
