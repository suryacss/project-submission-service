...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ActivityHistory
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class ActivityHistory : sObject
  {
    ...
    private EmailMessage alternateDetailField;
    private string alternateDetailIdField;
    ...
    {
      get => this.alternateDetailField;
      set => this.alternateDetailField = value;
    }

    [XmlElement(IsNullable = true)]
    public string AlternateDetailId
    {
      get => this.alternateDetailIdField;
      set => this.alternateDetailIdField = value;
    }
