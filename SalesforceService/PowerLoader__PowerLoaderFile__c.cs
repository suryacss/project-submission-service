...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__PowerLoaderFile__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PowerLoader__PowerLoaderFile__c : sObject
  {
    ...
    private double? powerLoader__Records__cField;
    private bool powerLoader__Records__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public double? PowerLoader__Records__c
    {
      get => this.powerLoader__Records__cField;
      set => this.powerLoader__Records__cField = value;
    }

    [XmlIgnore]
    public bool PowerLoader__Records__cSpecified
    {
      get => this.powerLoader__Records__cFieldSpecified;
      set => this.powerLoader__Records__cFieldSpecified = value;
    }
