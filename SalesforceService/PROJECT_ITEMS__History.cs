...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PROJECT_ITEMS__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PROJECT_ITEMS__History : sObject
  {
    ...
    private PROJECT_ITEMS__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public PROJECT_ITEMS__c Parent
    {
