...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Contract_Project_Tracker__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class Contract_Project_Tracker__History : sObject
  {
    ...
    private Contract_Project_Tracker__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public Contract_Project_Tracker__c Parent
    {
