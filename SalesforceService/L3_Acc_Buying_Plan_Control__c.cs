...
// Type: ProjectSubmissionsSvcLib.SalesforceService.L3_Acc_Buying_Plan_Control__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class L3_Acc_Buying_Plan_Control__c : sObject
  {
    ...
    private bool? l3_Acc_Car_Buying_Plan_Metadata_Updates__cField;
    private bool l3_Acc_Car_Buying_Plan_Metadata_Updates__cFieldSpecified;
    private bool? l3_Acc_Car_Buying_Plan_Trigger__cField;
    private bool l3_Acc_Car_Buying_Plan_Trigger__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? L3_Acc_Car_Buying_Plan_Metadata_Updates__c
    {
      get => this.l3_Acc_Car_Buying_Plan_Metadata_Updates__cField;
      set => this.l3_Acc_Car_Buying_Plan_Metadata_Updates__cField = value;
    }

    [XmlIgnore]
    public bool L3_Acc_Car_Buying_Plan_Metadata_Updates__cSpecified
    {
      get => this.l3_Acc_Car_Buying_Plan_Metadata_Updates__cFieldSpecified;
      set => this.l3_Acc_Car_Buying_Plan_Metadata_Updates__cFieldSpecified = value;
    }

    [XmlElement(IsNullable = true)]
    public bool? L3_Acc_Car_Buying_Plan_Trigger__c
    {
      get => this.l3_Acc_Car_Buying_Plan_Trigger__cField;
      set => this.l3_Acc_Car_Buying_Plan_Trigger__cField = value;
    }

    [XmlIgnore]
    public bool L3_Acc_Car_Buying_Plan_Trigger__cSpecified
    {
      get => this.l3_Acc_Car_Buying_Plan_Trigger__cFieldSpecified;
      set => this.l3_Acc_Car_Buying_Plan_Trigger__cFieldSpecified = value;
    }
