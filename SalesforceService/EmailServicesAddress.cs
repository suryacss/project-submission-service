...
// Type: ProjectSubmissionsSvcLib.SalesforceService.EmailServicesAddress
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class EmailServicesAddress : sObject
  {
    ...
    private string emailDomainNameField;
    private EmailServicesFunction functionField;
    ...
    private string runAsUserIdField;
    ...
    {
      get => this.emailDomainNameField;
      set => this.emailDomainNameField = value;
    }

    [XmlElement(IsNullable = true)]
    public EmailServicesFunction Function
    {
      get => this.functionField;
    ...
    {
      get => this.functionIdField;
      set => this.functionIdField = value;
    }
    ...
    {
      get => this.localPartField;
      set => this.localPartField = value;
    }

    [XmlElement(IsNullable = true)]
    public string RunAsUserId
    {
      get => this.runAsUserIdField;
      set => this.runAsUserIdField = value;
    }
