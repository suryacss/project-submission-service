...
// Type: ProjectSubmissionsSvcLib.SalesforceService.L3_Circuit_Control__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class L3_Circuit_Control__c : sObject
  {
    ...
    private bool? disable_Cir_Update_Callout__cField;
    private bool disable_Cir_Update_Callout__cFieldSpecified;
    ...
    private bool? l3_Circuit_Trigger__cField;
    private bool l3_Circuit_Trigger__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? Disable_Cir_Update_Callout__c
    {
      get => this.disable_Cir_Update_Callout__cField;
      set => this.disable_Cir_Update_Callout__cField = value;
    }

    [XmlIgnore]
    public bool Disable_Cir_Update_Callout__cSpecified
    {
      get => this.disable_Cir_Update_Callout__cFieldSpecified;
      set => this.disable_Cir_Update_Callout__cFieldSpecified = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public bool? L3_Circuit_Trigger__c
    {
      get => this.l3_Circuit_Trigger__cField;
      set => this.l3_Circuit_Trigger__cField = value;
    }

    [XmlIgnore]
    public bool L3_Circuit_Trigger__cSpecified
    {
      get => this.l3_Circuit_Trigger__cFieldSpecified;
      set => this.l3_Circuit_Trigger__cFieldSpecified = value;
    }
