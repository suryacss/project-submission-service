...
// Type: ProjectSubmissionsSvcLib.SalesforceService.STATE_OPTIONS__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class STATE_OPTIONS__c : sObject
  {
    ...
    {
      get => this.sTATE__cField;
      set => this.sTATE__cField = value;
    }
