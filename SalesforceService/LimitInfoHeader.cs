...
// Type: ProjectSubmissionsSvcLib.SalesforceService.LimitInfoHeader
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class LimitInfoHeader : SoapHeader
  {
    private LimitInfo[] limitInfoField;

    [XmlElement("limitInfo")]
    public LimitInfo[] limitInfo
    {
      get => this.limitInfoField;
      set => this.limitInfoField = value;
    }
  }
}
