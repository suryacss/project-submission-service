...
// Type: ProjectSubmissionsSvcLib.SalesforceService.UserProvAccount
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class UserProvAccount : sObject
  {
    ...
    private bool? isKnownLinkField;
    private bool isKnownLinkFieldSpecified;
    ...
    {
      get => this.deletedDateField;
      set => this.deletedDateField = value;
    }

    [XmlIgnore]
    public bool DeletedDateSpecified
    {
      get => this.deletedDateFieldSpecified;
      set => this.deletedDateFieldSpecified = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public bool? IsKnownLink
    {
      get => this.isKnownLinkField;
      set => this.isKnownLinkField = value;
    }

    [XmlIgnore]
    public bool IsKnownLinkSpecified
    {
      get => this.isKnownLinkFieldSpecified;
      set => this.isKnownLinkFieldSpecified = value;
    }
