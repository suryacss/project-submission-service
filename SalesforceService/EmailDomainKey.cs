...
// Type: ProjectSubmissionsSvcLib.SalesforceService.EmailDomainKey
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class EmailDomainKey : sObject
  {
    ...
    private string domainMatchField;
    ...
    {
      get => this.domainMatchField;
      set => this.domainMatchField = value;
    }
