...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ColocationType_Options__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class ColocationType_Options__c : sObject
  {
    private QueryResult attachedContentDocumentsField;
    private string colocationType__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string ColocationType__c
    {
      get => this.colocationType__cField;
      set => this.colocationType__cField = value;
    }
