...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Level3_Vendor_Mgmt_Integration_Settings__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class Level3_Vendor_Mgmt_Integration_Settings__c : sObject
  {
    ...
    private string production_Integration_Endpoint__cField;
    private string production_Organization_ID__cField;
    ...
    private string test_Integration_Endpoint__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string Production_Integration_Endpoint__c
    {
      get => this.production_Integration_Endpoint__cField;
      set => this.production_Integration_Endpoint__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public string Production_Organization_ID__c
    {
      get => this.production_Organization_ID__cField;
      set => this.production_Organization_ID__cField = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public string Test_Integration_Endpoint__c
    {
      get => this.test_Integration_Endpoint__cField;
      set => this.test_Integration_Endpoint__cField = value;
    }
