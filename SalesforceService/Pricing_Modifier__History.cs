...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Pricing_Modifier__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class Pricing_Modifier__History : sObject
  {
    ...
    private Pricing_Modifier__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public Pricing_Modifier__c Parent
    {
