...
// Type: ProjectSubmissionsSvcLib.SalesforceService.L3_ECCKT_Supplemental_Control__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class L3_ECCKT_Supplemental_Control__c : sObject
  {
    ...
    private bool? l3_Ecckt_Sup_Metadata_Updates__cField;
    private bool l3_Ecckt_Sup_Metadata_Updates__cFieldSpecified;
    private bool? l3_Ecckt_Sup_Trigger_ODM_Callouts__cField;
    private bool l3_Ecckt_Sup_Trigger_ODM_Callouts__cFieldSpecified;
    private bool? l3_Ecckt_Sup_Trigger__cField;
    private bool l3_Ecckt_Sup_Trigger__cFieldSpecified;
    private bool? l3_Ecckt_Sup_Update_SystemId__cField;
    private bool l3_Ecckt_Sup_Update_SystemId__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? L3_Ecckt_Sup_Metadata_Updates__c
    {
      get => this.l3_Ecckt_Sup_Metadata_Updates__cField;
      set => this.l3_Ecckt_Sup_Metadata_Updates__cField = value;
    }

    [XmlIgnore]
    public bool L3_Ecckt_Sup_Metadata_Updates__cSpecified
    {
      get => this.l3_Ecckt_Sup_Metadata_Updates__cFieldSpecified;
      set => this.l3_Ecckt_Sup_Metadata_Updates__cFieldSpecified = value;
    }

    [XmlElement(IsNullable = true)]
    public bool? L3_Ecckt_Sup_Trigger_ODM_Callouts__c
    {
      get => this.l3_Ecckt_Sup_Trigger_ODM_Callouts__cField;
      set => this.l3_Ecckt_Sup_Trigger_ODM_Callouts__cField = value;
    }

    [XmlIgnore]
    public bool L3_Ecckt_Sup_Trigger_ODM_Callouts__cSpecified
    {
      get => this.l3_Ecckt_Sup_Trigger_ODM_Callouts__cFieldSpecified;
      set => this.l3_Ecckt_Sup_Trigger_ODM_Callouts__cFieldSpecified = value;
    }

    [XmlElement(IsNullable = true)]
    public bool? L3_Ecckt_Sup_Trigger__c
    {
      get => this.l3_Ecckt_Sup_Trigger__cField;
      set => this.l3_Ecckt_Sup_Trigger__cField = value;
    }

    [XmlIgnore]
    public bool L3_Ecckt_Sup_Trigger__cSpecified
    {
      get => this.l3_Ecckt_Sup_Trigger__cFieldSpecified;
      set => this.l3_Ecckt_Sup_Trigger__cFieldSpecified = value;
    }

    [XmlElement(IsNullable = true)]
    public bool? L3_Ecckt_Sup_Update_SystemId__c
    {
      get => this.l3_Ecckt_Sup_Update_SystemId__cField;
      set => this.l3_Ecckt_Sup_Update_SystemId__cField = value;
    }

    [XmlIgnore]
    public bool L3_Ecckt_Sup_Update_SystemId__cSpecified
    {
      get => this.l3_Ecckt_Sup_Update_SystemId__cFieldSpecified;
      set => this.l3_Ecckt_Sup_Update_SystemId__cFieldSpecified = value;
    }
