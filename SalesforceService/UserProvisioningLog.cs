...
// Type: ProjectSubmissionsSvcLib.SalesforceService.UserProvisioningLog
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class UserProvisioningLog : sObject
  {
    ...
    private UserProvisioningRequest userProvisioningRequestField;
    private string userProvisioningRequestIdField;
    ...
    {
      get => this.userProvisioningRequestField;
      set => this.userProvisioningRequestField = value;
    }

    [XmlElement(IsNullable = true)]
    public string UserProvisioningRequestId
    {
      get => this.userProvisioningRequestIdField;
      set => this.userProvisioningRequestIdField = value;
    }
