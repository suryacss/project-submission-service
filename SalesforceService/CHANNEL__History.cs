...
// Type: ProjectSubmissionsSvcLib.SalesforceService.CHANNEL__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class CHANNEL__History : sObject
  {
    ...
    private CHANNEL__c parentField;
