...
// Type: ProjectSubmissionsSvcLib.SalesforceService.TransmissionType_Options__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class TransmissionType_Options__c : sObject
  {
    ...
    private string transmissionType__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string TransmissionType__c
    {
      get => this.transmissionType__cField;
      set => this.transmissionType__cField = value;
    }
