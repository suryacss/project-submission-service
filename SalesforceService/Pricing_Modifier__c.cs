...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Pricing_Modifier__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class Pricing_Modifier__c : sObject
  {
    ...
    private string pricing_Structure__cField;
    private ProjectSubmissionsSvcLib.SalesforceService.Pricing_Structure__c pricing_Structure__rField;
    ...
    [XmlElement(IsNullable = true)]
    public string Pricing_Structure__c
    {
      get => this.pricing_Structure__cField;
      set => this.pricing_Structure__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public ProjectSubmissionsSvcLib.SalesforceService.Pricing_Structure__c Pricing_Structure__r
    {
      get => this.pricing_Structure__rField;
      set => this.pricing_Structure__rField = value;
    }
