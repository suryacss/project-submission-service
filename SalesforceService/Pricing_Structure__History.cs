...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Pricing_Structure__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class Pricing_Structure__History : sObject
  {
    ...
    private Pricing_Structure__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public Pricing_Structure__c Parent
    {
