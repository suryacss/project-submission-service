...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ProcessInstanceStep
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class ProcessInstanceStep : sObject
  {
    ...
    private string stepNodeIdField;
    ...
    [XmlElement(IsNullable = true)]
    public string StepNodeId
    {
      get => this.stepNodeIdField;
      set => this.stepNodeIdField = value;
    }
