...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ListView
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  public class ListView : sObject
  {
    ...
    private bool? isSoqlCompatibleField;
    private bool isSoqlCompatibleFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? IsSoqlCompatible
    {
      get => this.isSoqlCompatibleField;
      set => this.isSoqlCompatibleField = value;
    }

    [XmlIgnore]
    public bool IsSoqlCompatibleSpecified
    {
      get => this.isSoqlCompatibleFieldSpecified;
      set => this.isSoqlCompatibleFieldSpecified = value;
    }
