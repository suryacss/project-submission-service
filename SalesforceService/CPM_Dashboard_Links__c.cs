...
// Type: ProjectSubmissionsSvcLib.SalesforceService.CPM_Dashboard_Links__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class CPM_Dashboard_Links__c : sObject
  {
    ...
    private string display__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string Display__c
    {
      get => this.display__cField;
      set => this.display__cField = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public string URL__c
    {
      get => this.uRL__cField;
      set => this.uRL__cField = value;
    }
