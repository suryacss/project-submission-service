...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Puma_Project_Settings__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class Puma_Project_Settings__c : sObject
  {
    ...
    private bool? create_Placeholder_Circuit__cField;
    private bool create_Placeholder_Circuit__cFieldSpecified;
    ...
    private string preCreate_Sub_Projects__cField;
    ...
    private string workflow_Types__cField;
    ...
    [XmlElement(IsNullable = true)]
    public bool? Create_Placeholder_Circuit__c
    {
      get => this.create_Placeholder_Circuit__cField;
      set => this.create_Placeholder_Circuit__cField = value;
    }

    [XmlIgnore]
    public bool Create_Placeholder_Circuit__cSpecified
    {
      get => this.create_Placeholder_Circuit__cFieldSpecified;
      set => this.create_Placeholder_Circuit__cFieldSpecified = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public string PreCreate_Sub_Projects__c
    {
      get => this.preCreate_Sub_Projects__cField;
      set => this.preCreate_Sub_Projects__cField = value;
    }
    ...
    [XmlElement(IsNullable = true)]
    public string Workflow_Types__c
    {
      get => this.workflow_Types__cField;
      set => this.workflow_Types__cField = value;
    }
  }
}
