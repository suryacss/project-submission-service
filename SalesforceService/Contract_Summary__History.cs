...
// Type: ProjectSubmissionsSvcLib.SalesforceService.Contract_Summary__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class Contract_Summary__History : sObject
  {
    ...
    private Contract_Summary__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public Contract_Summary__c Parent
    {
