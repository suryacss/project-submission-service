...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__QueryPanelTemplateField__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class PowerLoader__QueryPanelTemplateField__c : sObject
  {
    ...
    private string powerLoader__QueryPanelTemplate__cField;
    private ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__QueryPanelTemplate__c powerLoader__QueryPanelTemplate__rField;
    private string powerLoader__Value__cField;
    ...
    [XmlElement(IsNullable = true)]
    public string PowerLoader__QueryPanelTemplate__c
    {
      get => this.powerLoader__QueryPanelTemplate__cField;
      set => this.powerLoader__QueryPanelTemplate__cField = value;
    }

    [XmlElement(IsNullable = true)]
    public ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__QueryPanelTemplate__c PowerLoader__QueryPanelTemplate__r
    {
      get => this.powerLoader__QueryPanelTemplate__rField;
      set => this.powerLoader__QueryPanelTemplate__rField = value;
    }

    [XmlElement(IsNullable = true)]
    public string PowerLoader__Value__c
    {
      get => this.powerLoader__Value__cField;
      set => this.powerLoader__Value__cField = value;
    }
