...
// Type: ProjectSubmissionsSvcLib.SalesforceService.ACC_CAR_BUYING_PLAN__History
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class ACC_CAR_BUYING_PLAN__History : sObject
  {
    ...
    private ACC_CAR_BUYING_PLAN__c parentField;
    ...
    [XmlElement(IsNullable = true)]
    public ACC_CAR_BUYING_PLAN__c Parent
    {
