...
// Type: ProjectSubmissionsSvcLib.SalesforceService.PowerLoader__ObjectTemplate__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [Serializable]
  public class PowerLoader__ObjectTemplate__c : sObject
  {
    ...
    private DateTime? powerLoader__DateTemplate__cField;
    private bool powerLoader__DateTemplate__cFieldSpecified;
    private double? powerLoader__NumberTemplate__cField;
    private bool powerLoader__NumberTemplate__cFieldSpecified;
    ...
    public DateTime? PowerLoader__DateTemplate__c
    {
      get => this.powerLoader__DateTemplate__cField;
      set => this.powerLoader__DateTemplate__cField = value;
    }

    [XmlIgnore]
    public bool PowerLoader__DateTemplate__cSpecified
    {
      get => this.powerLoader__DateTemplate__cFieldSpecified;
      set => this.powerLoader__DateTemplate__cFieldSpecified = value;
    }

    [XmlElement(IsNullable = true)]
    public double? PowerLoader__NumberTemplate__c
    {
      get => this.powerLoader__NumberTemplate__cField;
      set => this.powerLoader__NumberTemplate__cField = value;
    }

    [XmlIgnore]
    public bool PowerLoader__NumberTemplate__cSpecified
    {
      get => this.powerLoader__NumberTemplate__cFieldSpecified;
      set => this.powerLoader__NumberTemplate__cFieldSpecified = value;
    }
