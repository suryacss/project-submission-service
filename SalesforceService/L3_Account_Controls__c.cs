...
// Type: ProjectSubmissionsSvcLib.SalesforceService.L3_Account_Controls__c
...
namespace ProjectSubmissionsSvcLib.SalesforceService
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class L3_Account_Controls__c : sObject
  {
    ...
    private bool? l3_Acc_Car_Vendor_Metadata_Updates__cField;
    private bool l3_Acc_Car_Vendor_Metadata_Updates__cFieldSpecified;
    private bool? l3_Acc_Car_Vendor_Trigger__cField;
    private bool l3_Acc_Car_Vendor_Trigger__cFieldSpecified;
    ...
    [XmlElement(IsNullable = true)]
    public bool? L3_Acc_Car_Vendor_Metadata_Updates__c
    {
      get => this.l3_Acc_Car_Vendor_Metadata_Updates__cField;
      set => this.l3_Acc_Car_Vendor_Metadata_Updates__cField = value;
    }

    [XmlIgnore]
    public bool L3_Acc_Car_Vendor_Metadata_Updates__cSpecified
    {
      get => this.l3_Acc_Car_Vendor_Metadata_Updates__cFieldSpecified;
      set => this.l3_Acc_Car_Vendor_Metadata_Updates__cFieldSpecified = value;
    }

    [XmlElement(IsNullable = true)]
    public bool? L3_Acc_Car_Vendor_Trigger__c
    {
      get => this.l3_Acc_Car_Vendor_Trigger__cField;
      set => this.l3_Acc_Car_Vendor_Trigger__cField = value;
    }

    [XmlIgnore]
    public bool L3_Acc_Car_Vendor_Trigger__cSpecified
    {
      get => this.l3_Acc_Car_Vendor_Trigger__cFieldSpecified;
      set => this.l3_Acc_Car_Vendor_Trigger__cFieldSpecified = value;
    }
